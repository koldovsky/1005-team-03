const carousel = document.querySelector('.food-menu .collection__carousel');
const carouselInner = document.querySelector('.food-menu .collection__carousel__inner');
const prevButton = document.querySelector('.food-menu .carousel__btn-prev')
const nextButton = document.querySelector('.food-menu .carousel__btn-next');
